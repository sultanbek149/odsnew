...
function q(i) {
    ...
    return {
        c() {
            e = u("div"),
                s = u("video"),
                s.innerHTML = '<source data-desktop-src="assets/videos/sections-desctop/video-3.mov" data-mobile-src="assets/videos/sections-mobile/video-2.mov" type="video/mp4; codecs=&quot;hvc1&quot;"/><source data-desktop-src="assets/videos/sections-desctop/video-2.webm" data-mobile-src="assets/videos/sections-mobile/video-2.webm" type="video/webm"/>',
                o = p(),
                t = u("h2"),
                t.textContent = "LULU",
                d = p(),
                l = u("div"),
                l.innerHTML = `IS YOUR SOFTWARE INTERFACE BETWEEN<br/>
        BASE REALITY AND MIXED REALITY`,
                s.playsInline = !0,
                s.muted = !0,
                s.loop = !0,
